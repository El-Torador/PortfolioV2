...
function HireMe() {
  return <div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:-top-3 md:bottom-auto md:absolute">
