        ...
        <div className="mx-auto">
          ...
          <div className="mt-8">
            ...
            <p>
              ...
              Il vient rajouter de la qualité dans le code produit tout en documentant celui-ci. Ce qui facilite la maintenance et assure la sécurité des futures modifications. Dans la communauté des développeurs, le TDD est souvent connu comme un perd temps car écrire des tests prend du temps et celà revient à écrire du double code (celui des test et celui qui va être testé). les avis sont assez partagé sur le sujet où d'un côté on aura les puristes qui ne jurent que par le TDD, ensuite des neutres qui vont l'utiliser de temps en temps et enfin les opposants qui ne l'utilisent pas du tout.
            </p>
            ...
            <p>
              Alors que la granularité de développement était un détail lors de la construction des logiciel, aujourd’hui elle est entretenu grace aux TDD avec une adoption croissance par les entreprise depuis 2015 <b>(plus de 80% des entreprises Tech adoptent le TDD)</b>. En 2003, <b>Kent Beck</b> va démocratiser le TDD dans son livre <b>"Test-Driven Development: By Example"</b> après avoir expérimenter et promu ces idées en 1990 à travers le mouvement <b>Extreme Programming (XP)</b> qui visait à populariser les pratiques liées au TDD.<br /><br /> Grace à son brillant travail, la communauté commence à s'intéresser de plus en plus à cette méthode et une pléthore d'outils de tests voient le jour. Le principe de cette méthode est de se concentrer sur les <b>comportements</b> afin de fournir un <b>Feedback rapide et de qualité</b>. Pour se faire, nous devons nous rassurer à chaque itération mineure que le code produit soit utile (pour ne pas avoir de code mort), ait le comportement attendu et ne casse pas les comportements existants.
            </p>
          </div>
